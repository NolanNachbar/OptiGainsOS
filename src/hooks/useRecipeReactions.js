...
export function useRecipeReactions(sharedRecipeId) {
  const { user } = useAuth();
  const queryClient = useQueryClient();

  const queryKey = queryKeys.recipeReactions(sharedRecipeId);

  // Fetch reaction stats for this recipe
