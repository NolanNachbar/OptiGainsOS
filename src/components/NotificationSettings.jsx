  ...
  return (
    <div className="p-4 rounded-xl bg-charcoal-surface border border-charcoal-border">
      <div className="flex items-start justify-between gap-3">
        ...
        {isSubscribed ? (
          <Button variant="ghost" size="sm" onClick={unsubscribe} className="h-7 px-3 text-xs text-red-400 hover:bg-red-500/10 shrink-0">
            Disable
          </Button>
        ) : (
          <Button
      ...
      {permission === "denied" && (
        <div className="mt-3 flex items-start gap-1.5 text-xs text-yellow-400">
