    ...
    <div className="w-full">
      <div className="grid grid-cols-4 gap-3 mb-6">
        <div className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-[10px] p-4">
          <div className="text-[11px] text-[#555555] uppercase tracking-wide mb-1">Starting</div>
        ...
        <div className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-[10px] p-4">
          <div className="text-[11px] text-[#555555] uppercase tracking-wide mb-1">Current</div>
        ...
        <div className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-[10px] p-4">
          <div className="text-[11px] text-[#555555] uppercase tracking-wide mb-1">Trend</div>
        ...
        <div className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-[10px] p-4">
          <div className="text-[11px] text-[#555555] uppercase tracking-wide mb-1">Change</div>
          ...
          <div className="text-[11px] text-[#555555] font-mono mt-0.5">{percentChange > 0 ? '+' : ''}{percentChange}%</div>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center gap-6 mt-3 text-[11px] text-[#555555] font-mono">
