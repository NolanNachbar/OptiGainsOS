...
export default function Progress() {
  ...
  const LOG_LIMIT = 500;
  const { data: workoutLogsRaw = [], isLoading } = useQuery({
  ...
  const workoutLogs = workoutLogsRaw;
  const logsAreTruncated = workoutLogsRaw.length === LOG_LIMIT;
  ...
  return (
    <div className="p-4 md:p-8 bg-gradient-to-br from-slate-50 to-slate-100 min-h-screen">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-slate-900 dark:text-white">Progress & Analytics</h1>
          <p className="text-slate-600 mt-1">Track your strength, workouts, and body weight</p>
        </div>
        ...
        <Tabs defaultValue="overview" className="w-full" onValueChange={setActiveTab}>
          ...
          <TabsContent value="overview">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <Card className="border-none shadow-lg">
                ...
                <CardContent>
                  <div className="text-3xl font-bold text-slate-900 dark:text-white">{totalWorkouts}</div>
                </CardContent>
              </Card>
          ...
          <TabsContent value="logs">
            ...
            {logsAreTruncated && (
              <p className="text-xs text-slate-400 text-center mb-2">
                Showing your {LOG_LIMIT} most recent workouts. Stats reflect this window.
              </p>
            )}
          ...
          <TabsContent value="bodyweight">
            ...
            {weightEntries.length > 0 && activeTab === "bodyweight" && (
              <Card className="border-none shadow-lg mb-6">
                <CardHeader>
